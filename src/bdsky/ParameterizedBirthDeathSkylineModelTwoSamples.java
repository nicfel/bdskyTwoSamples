...
public class ParameterizedBirthDeathSkylineModelTwoSamples extends SpeciesTreeDistribution {
    ...
    public double calculateTreeLogLikelihood(TreeInterface tree) {
        ...
        switch (conditionOn) {
            ...
            case SURVIVAL:
                ...
                if (temp == 1)
                    return Double.NEGATIVE_INFINITY;
                temp = Math.log(g(index, times[index], x0) / (1 - temp-g(index, times[index], x0))); // Tanja: function g is function q_i in pnas 2013 paper. hack Tanja to condition on at least 2 samples. 5.7.18.
